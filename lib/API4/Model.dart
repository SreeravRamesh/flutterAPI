...
//
//     final dataModelNew = dataModelNewFromJson(jsonString);

import 'dart:convert';

DataModelNew dataModelNewFromJson(String str) => DataModelNew.fromJson(json.decode(str));

String dataModelNewToJson(DataModelNew data) => json.encode(data.toJson());
...
class DataModelNew {
  ...
  factory DataModelNew.fromJson(Map<String, dynamic> json) => DataModelNew(
